...
#Region "Extensibility Method Definitions"
   ...
   End Sub
   Partial Private Sub OnsBesitzerChanging(ByVal value As String)
   End Sub
   Partial Private Sub OnsBesitzerChanged()
   End Sub
#End Region
   ...
   Public Property CostCenter() As System.Nullable(Of Long)
      ...
      End Set
   End Property
   <Column(Name:="sITManager", Storage:="_sITManager", DbType:="NVarChar(64) NULL", CanBeNull:=True)> _
   Public Property ITManager() As String
      ...
      End Set
   End Property
   <Column(Name:="sBesitzer", Storage:="_sBesitzer", DbType:="NVarChar(30) NULL", CanBeNull:=True)> _
   Public Property Besitzer() As String
      Get
         Return Me._sBesitzer
      End Get
      Set(ByVal value As String)
         If (String.Equals(Me._sBesitzer, value) = False) Then
            Me.OnsBesitzerChanging(value)
            Me.SendPropertyChanging()
            Me._sBesitzer = value
            Me.SendPropertyChanged("sBesitzer")
            Me.OnsBesitzerChanged()
         End If
      End Set
   End Property
...
#Region "Extensibility Method Definitions"
   ...
   End Sub
   Partial Private Sub OnsCostCenterChanging(ByVal value As String)
   End Sub
   Partial Private Sub OnsCostCenterChanged()
   End Sub
   Partial Private Sub OnsItManagerChanging(ByVal value As String)
   End Sub
   Partial Private Sub OnsItManagerChanged()
   End Sub
   Partial Private Sub OnsOrderActionChanging(ByVal value As String)
   End Sub
   Partial Private Sub OnsOrderActionChanged()
   End Sub
   ...
   End Sub
   Partial Private Sub OniOrderItemIDChanging(ByVal value As Nullable(Of Integer))
   End Sub
...
#End Region
   ...
   Public Property CostCenterResponsible() As String
      ...
      End Set
   End Property
   <Column(Name:="sCostCenter", Storage:="_sCostCenter", DbType:="NVarChar(32)")> _
Public Property CostCenter() As String
      Get
         Return Me._sCostCenter
      End Get
      Set(ByVal value As String)
         If (String.Equals(Me._sCostCenter, value) = False) Then
            Me.OnsCostCenterChanging(value)
            Me.SendPropertyChanging()
            Me._sCostCenter = value
            Me.SendPropertyChanged("sCostCenter")
            Me.OnsCostCenterChanged()
         End If
      End Set
   End Property
   ...
   Public Property ITManager() As String
      ...
      End Set
   End Property
   <Column(Name:="sOrderAction", Storage:="_sOrderAction", DbType:="NVarChar(32)")> _
Public Property OrderAction() As String
      Get
         Return Me._sOrderAction
      End Get
      Set(ByVal value As String)
         If (String.Equals(Me._sOrderAction, value) = False) Then
            Me.OnsOrderActionChanging(value)
            Me.SendPropertyChanging()
            Me._sOrderAction = value
            Me.SendPropertyChanged("sOrderAction")
            Me.OnsOrderActionChanged()
         End If
      End Set
   End Property
   ...
   Public Property DateConfirmed() As System.Nullable(Of Date)
      ...
      End Set
   End Property
   <Column(Name:="iOrderItemID", Storage:="_iOrderItemID", DbType:="Int")> _
  Public Property OrderItemID() As System.Nullable(Of Integer)
      Get
         Return Me._iOrderItemID
      End Get
      Set(ByVal value As System.Nullable(Of Integer))
         If (Me._iOrderItemID.Equals(value) = False) Then
   ...
   Public Property OrderableItem() As OrderableItem
      ...
      End Set
   End Property
   <Association(Name:="FK_tblConfirmedItems_tblOrderItems", Storage:="_OrderItem", ThisKey:="OrderItemID", OtherKey:="ID", IsForeignKey:=True)> _
      ...
      Set(ByVal value As OrderItem)
         ...
         If ((Object.Equals(previousValue, value) = False) _
            ...
            If ((value Is Nothing) _
               ...
               Me._iOrderableItemsID = value.ID
            Else
               Me._iOrderItemID = CType(Nothing, Nullable(Of Integer))
            End If
            Me.SendPropertyChanged("OrderItem")
         End If
      End Set
   End Property
   <Association(Name:="FK_tblItems_tblConfirmedItems", Storage:="_Item", ThisKey:="ID", OtherKey:="ConfirmedItemID", DeleteRule:="CASCADE")> _
Public Property Item() As EntitySet(Of Item)
      Get
         Return Me._Item
      End Get
...
Public Class ConfirmedItemPredicate
   ...
   Public Function CompareIDs(ByVal obj As ConfirmedItem) As Boolean
      Return (_ID = obj.ID)
   End Function
   Public Function CompareOrderItemIDs(ByVal obj As ConfirmedItem) As Boolean
      If obj.OrderItemID.HasValue Then
         If obj.OrderItemID = _ID Then
            Return True
         Else
            Return False
         End If
...
Partial Public Class Item
   ...
   Private _sAssigner As String
   Private _iAccountingUnitID As System.Nullable(Of Integer)
   Private _sAimsID As String
   Private _iConfirmedItemID As System.Nullable(Of Integer)
...
#Region "Extensibility Method Definitions"
   ...
   End Sub
   Partial Private Sub OnsAssignerChanging(ByVal value As String)
   End Sub
   Partial Private Sub OnsAssignerChanged()
   End Sub
   Partial Private Sub OniAccountingUnitIDChanging(ByVal value As System.Nullable(Of Integer))
   End Sub
   Partial Private Sub OniAccountingUnitIDChanged()
   End Sub
   Partial Private Sub OnsAimsIDChanging(ByVal value As String)
   End Sub
   Partial Private Sub OnsAimsIDChanged()
   End Sub
   Partial Private Sub OndAccountingChanging(ByVal value As System.Nullable(Of Date))
   End Sub
   Partial Private Sub OndAccountingChanged()
   End Sub
   Partial Private Sub OniConfirmedItemIDChanging(ByVal value As System.Nullable(Of Integer))
   End Sub
   Partial Private Sub OniConfirmedItemIDChanged()
   End Sub
#End Region
   ...
   Public Property Delivery() As Date
      ...
      Set(ByVal value As Date)
         If ((Me._dDelivery = value) = False) Then
 ...
 Public Property Price() As Double
   ...
   Public Property Recipient() As String
      ...
      End Set
   End Property
   <Column(Name:="sAssigner", Storage:="_sAssigner", DbType:="NVarChar(64)")> _
   Public Property Assigner() As String
      Get
         Return Me._sAssigner
      End Get
      Set(ByVal value As String)
         If (String.Equals(Me._sAssigner, value) = False) Then
            Me.OnsAssignerChanging(value)
            Me.SendPropertyChanging()
            Me._sAssigner = value
            Me.SendPropertyChanged("sAssigner")
            Me.OnsAssignerChanged()
         End If
      End Set
   End Property
   ...
   Public Property AccountingUnitID() As System.Nullable(Of Integer)
      ...
      End Set
   End Property
   <Column(Name:="sAimsID", Storage:="_sAimsID", DbType:="NvarChar(16)")> _
   Public Property AimsID() As String
      Get
         Return Me._sAimsID
      End Get
      Set(ByVal value As String)
         If (String.Equals(Me._sAimsID, value) = False) Then
            Me.OnsAimsIDChanging(value)
            Me.SendPropertyChanging()
            Me._sAimsID = value
            Me.SendPropertyChanged("sAimsID")
            Me.OnsAimsIDChanged()
         End If
      End Set
   End Property
  ...
  Public Property Accounting() As System.Nullable(Of Date)
      ...
      End Set
   End Property
    <Column(Name:="iConfirmedItemID", Storage:="_iConfirmedItemID", DbType:="Int")> _
    Public Property ConfirmedItemID() As System.Nullable(Of Integer)
        Get
            Return Me._iConfirmedItemID
        End Get
        Set(ByVal value As System.Nullable(Of Integer))
            If (Me._iConfirmedItemID.Equals(value) = False) Then
                If Me._ConfirmedItem.HasLoadedOrAssignedValue Then
                    Throw New System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException
                End If
                Me.OniConfirmedItemIDChanging(value)
                Me.SendPropertyChanging()
                Me._iConfirmedItemID = value
                Me.SendPropertyChanged("iConfirmedItemID")
                Me.OniConfirmedItemIDChanged()
            End If
        End Set
    End Property
   ...
   Public Property OrderItem() As OrderItem
      ...
      End Set
   End Property
   <Association(Name:="FK_tblItems_tblConfirmedItems", Storage:="_ConfirmedItem", ThisKey:="ConfirmedItemID", OtherKey:="ID", IsForeignKey:=True)> _
   Public Property ConfirmedItem() As ConfirmedItem
      Get
         Return Me._ConfirmedItem.Entity
      End Get
      Set(ByVal value As ConfirmedItem)
         ...
         If ((Object.Equals(previousValue, value) = False) _
            ...
            Me._ConfirmedItem.Entity = value
                If ((value Is Nothing) = False) Then
                    value.Item.Add(Me)
                    Me._iConfirmedItemID = value.ID
                    'Else
                    '    Me._iConfirmedItemID = CType(Nothing, Integer)
                End If
   ...
   Public Property sAccountingUnit() As String
      ...
      End Set
   End Property
   Public ReadOnly Property sAimsUrl() As String
      Get
         If _sAimsID Is Nothing Then
            Return ""
         ElseIf _sAimsID.StartsWith("G") Then
            Return My.Settings.AIMSurl & "aims.asp?trt=showitem&trv1=Computer&trv2=" & _sAimsID.Substring(2)
         ElseIf _sAimsID.StartsWith("Z") Then
            Return My.Settings.AIMSurl & "aims.asp?trt=showitem&trv1=Zubehoer&trv2=" & _sAimsID.Substring(2)
         Else
            Return ""
         End If
      End Get
...
Public Class ItemPredicate
   ...
   Public Function CompareIDs(ByVal obj As Item) As Boolean
      Return (_ID = obj.ID)
    End Function
   ...
   Public Function CompareShortID(ByVal obj As Item) As Boolean
      Return (_ItemID = obj.ItemID)
   End Function
End Class
...
Partial Public Class OrderableItem
   ...
   Private _sManufacturerDetails As String
   ...
   Private _iAimsStdSystemsID As System.Nullable(Of Integer)
   Private _ConfirmedItem As EntitySet(Of ConfirmedItem)
...
#Region "Extensibility Method Definitions"
   ...
   End Sub
   Partial Private Sub OnsManufacturerDetailsChanging(ByVal value As String)
   End Sub
   Partial Private Sub OnsManufacturerDetailsChanged()
   End Sub
   ...
   End Sub
   Partial Private Sub OnsImageChanging(ByVal value As String)
   End Sub
   Partial Private Sub OnsImageChanged()
   End Sub
   Partial Private Sub OnsCommentsChanging(ByVal value As String)
   End Sub
   Partial Private Sub OnsCommentsChanged()
   End Sub
   Partial Private Sub OnsItemAvailInOrgChanging(ByVal value As String)
   End Sub
   Partial Private Sub OnsItemAvailInOrgChanged()
   End Sub
   Partial Private Sub OniAimsStdSystemsIDChanging(ByVal value As Nullable(Of Integer))
   End Sub
   Partial Private Sub OniAimsStdSystemsIDChanged()
   End Sub
#End Region
 ...
 Public Property DeviceCategory() As String
   ...
   Public Property ManufacturerModel() As String
      ...
      End Set
   End Property
   <Column(Name:="sManufacturerDetails", Storage:="_sManufacturerDetails", DbType:="NVarChar(MAX)")> _
   Public Property ManufacturerDetails() As String
      Get
         Return Me._sManufacturerDetails
      End Get
      Set(ByVal value As String)
         If (String.Equals(Me._sManufacturerDetails, value) = False) Then
            Me.OnsManufacturerDetailsChanging(value)
            Me.SendPropertyChanging()
            Me._sManufacturerDetails = value
            Me.SendPropertyChanged("sManufacturerDetails")
            Me.OnsManufacturerDetailsChanged()
         End If
      End Set
   End Property
   ...
   Public Property UserfriendlyPrice() As System.Nullable(Of Decimal)
      ...
      End Set
   End Property
   <Column(Name:="sImage", Storage:="_sImage", DbType:="NVarChar(255)")> _
 Public Property Image() As String
      Get
         Return Me._sImage
      End Get
      Set(ByVal value As String)
         If (String.Equals(Me._sImage, value) = False) Then
      ...
      End Set
   End Property
   <Column(Name:="sComments", Storage:="_sComments", DbType:="NVarChar(MAX)")> _
 Public Property Comments() As String
      Get
         Return Me._sComments
      End Get
      Set(ByVal value As String)
         If (String.Equals(Me._sComments, value) = False) Then
            Me.OnsCommentsChanging(value)
            Me.SendPropertyChanging()
            Me._sComments = value
            Me.SendPropertyChanged("sComments")
            Me.OnsCommentsChanged()
         End If
      End Set
   End Property
 ...
 Public Property ItemAvailInOrg() As String
      ...
      End Set
   End Property
   <Column(Name:="iAimsStdSystemsID", Storage:="_iAimsStdSystemsID", DbType:="Int NULL")> _
 Public Property AimsStdSystemsID() As Nullable(Of Integer)
      Get
         Return Me._iAimsStdSystemsID
      End Get
      Set(ByVal value As Nullable(Of Integer))
         If (String.Equals(Me._iAimsStdSystemsID, value) = False) Then
            Me.OniAimsStdSystemsIDChanging(value)
            Me.SendPropertyChanging()
            Me._iAimsStdSystemsID = value
            Me.SendPropertyChanged("iAimsStdSystemsID")
            Me.OniAimsStdSystemsIDChanged()
         End If
      End Set
   End Property
...
Partial Public Class OrderItem
   ...
   Private _bFromDragging As System.Nullable(Of Boolean)
...
#Region "Extensibility Method Definitions"
   ...
   Partial Private Sub OniOrderableItemsIDChanged()
   End Sub
   Partial Private Sub OnbFromDraggingChanging(ByVal value As System.Nullable(Of Boolean))
   End Sub
   Partial Private Sub OnbFromDraggingChanged()
   End Sub
#End Region
   ...
   Public Sub New()
      ...
      Me._ConfirmedItems = New EntitySet(Of ConfirmedItem)(AddressOf Me.attach_ConfirmedItem, AddressOf Me.detach_ConfirmedItem)
      OnCreated()
   End Sub
 ...
 Public Property OrderID() As Integer
   ...
   Public Property OrderableItemsID() As System.Nullable(Of Integer)
      ...
      End Set
   End Property
   <Column(Name:="bFromDragging", Storage:="_bFromDragging", DbType:="Bit")> _
   Public Property FromDragging() As System.Nullable(Of Boolean)
      Get
         Return Me._bFromDragging
      End Get
      Set(ByVal value As System.Nullable(Of Boolean))
         If (Me._bFromDragging.Equals(value) = False) Then
            Me.OnbFromDraggingChanging(value)
            Me.SendPropertyChanging()
            Me._bFromDragging = value
            Me.SendPropertyChanged("bFromDragging")
            Me.OnbFromDraggingChanged()
         End If
      End Set
   End Property
 ...
 Public Property Order() As Order
      ...
      End Set
   End Property
   <Association(Name:="FK_tblConfirmedItems_tblOrderItems", Storage:="_ConfirmedItems", ThisKey:="ID", OtherKey:="OrderItemID", DeleteRule:="NO ACTION")> _
   ...
   Public Property sItemClass() As String
      ...
      End Set
   End Property
   Public ReadOnly Property sSupplierNo() As String
      Get
         If OrderableItem Is Nothing Then
            Return ""
         Else
            Return OrderableItem.SupplierNo
         End If
      End Get
   End Property
   Public ReadOnly Property cSumPrice() As Double
      Get
         Dim totPrice As Double = 0.0
         For Each it As Item In Items
            totPrice = totPrice + it.Price
         Next
         Return CDbl(Format(totPrice, "######.00"))
      End Get
   End Property
 ...
 Public Property SupplierID() As System.Nullable(Of Integer)
   ...
   Public ReadOnly Property TreeNode() As TreeNode
      Get
         ...
         End If
         nd.SelectedImageKey = nd.ImageKey
         nd.ToolTipText = Supplier.ShortID
         nd.Tag = ID
         nd.Name = Nr
         Return nd
      End Get
